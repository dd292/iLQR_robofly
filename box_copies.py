#This code is taken from open source repo https://github.com/tmwangcas/control-limited-iterative-lqr
import numpy as np
...
def boxQP(H, g, lower, upper, x0):
    ...
    for i in range(maxIter):
        ...
        if factorize:
            try:
                Hfree = (np.linalg.cholesky(H[free,:][:,free])).T  # 2d array, dim = [free, free]
